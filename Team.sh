#!/bin/bash
#Silahkan di recode :)
#Jangan Lupa Subscribe Hacker online
...
echo "Creadby  : NET CYBER INDO $white                                      " |lolcat
echo "Contact  : 0896xxxxxxxx   $white                             " |lolcat
echo "_____________________________________________________________"
...
6) echo "created by : NET CYBER INDO GANS" | lolcat
exit
;;
